    ...
    if (activeTrip) {
        return (
            <div className="p-4 pb-24 space-y-6 animate-fade-in">
                ...
                <button
                    onClick={() => navigate('/checkout', { state: { reportIssue: true } })}
    ...
    return (
        <div className="p-4 pb-24 space-y-6 animate-fade-in">
            ...
            <div className="text-center py-8">
                <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-primary-500/20 to-teal-500/20 flex items-center justify-center mb-4">
                    <Car size={40} className="text-primary-400" />
                </div>
            ...
            <button
                ...
                className="w-full py-6 bg-gradient-to-r from-primary-600 to-teal-500 
                    text-white font-bold text-xl rounded-2xl
