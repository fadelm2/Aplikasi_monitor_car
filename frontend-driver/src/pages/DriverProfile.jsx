    ...
    return (
        <div className="p-4 pb-24 animate-fade-in">
            ...
            <div className="glass rounded-2xl p-6 text-center mb-6">
                <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-primary-500 to-teal-600 flex items-center justify-center mb-4">
            ...
            <button
                ...
                className="w-full py-4 bg-red-500/10 border border-red-500/30 text-red-400 
                    font-semibold rounded-2xl hover:bg-red-500/20 active:bg-red-500/10 transition-colors
