        ...
        <div className="min-h-screen bg-dark-300 pb-24">
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-5">
                ...
                <div className="glass rounded-2xl p-5">
                    ...
                    {selectedCar && (
                        <div className="mt-4 p-4 bg-dark-200 rounded-xl flex items-center gap-4 animate-fade-in">
                ...
                <div className="glass rounded-2xl p-5">
                    ...
                    <div className="space-y-3">
                        <label className="flex items-center gap-4 p-4 bg-dark-200 rounded-xl cursor-pointer active:bg-dark-100 transition-colors">
                            <input
                                type="checkbox"
                            ...
                            <div className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-colors
                                ${formData.fuelOk ? 'bg-primary-500 border-primary-500' : 'border-gray-600'}`}>
                        ...
                        <label className="flex items-center gap-4 p-4 bg-dark-200 rounded-xl cursor-pointer active:bg-dark-100 transition-colors">
                            ...
                            />
                            <div className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-colors
                                ${formData.tiresOk ? 'bg-primary-500 border-primary-500' : 'border-gray-600'}`}>
                        ...
                        <label className="flex items-center gap-4 p-4 bg-dark-200 rounded-xl cursor-pointer active:bg-dark-100 transition-colors">
                            ...
                            />
                            <div className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-colors
                                ${formData.stnkOk ? 'bg-primary-500 border-primary-500' : 'border-gray-600'}`}>
                ...
                <div className="glass rounded-2xl p-5">
                    ...
                    {formData.photoPreview ? (
                        ...
                        <label
                            htmlFor="photo-input"
                            className="flex flex-col items-center justify-center h-40 bg-dark-200 border-2 border-dashed border-gray-600 rounded-xl cursor-pointer hover:border-primary-500 active:bg-dark-100 transition-colors"
                        >
                ...
                <button
                    type="submit"
                    disabled={submitting}
                    className="w-full py-5 bg-gradient-to-r from-primary-600 to-teal-500 
