...
export default function DriverLogin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // In a real app, the user would have a linked driver_id
            setAuth(token, {
                id: user.id,
                name: user.username,
                // Map user to driver - in production, this should come from backend
                driverId: user.id
            })
        ...
        <div className="min-h-screen bg-dark-300 flex flex-col items-center justify-center p-6">
            ...
            <div className="relative w-full max-w-sm">
                ...
                <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-br from-emerald-500 to-teal-600 mb-4 shadow-lg shadow-emerald-500/30">
                ...
                <div className="glass rounded-3xl p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 mt-4 bg-gradient-to-r from-emerald-600 to-teal-500 
